...
export const PersonsView = styled.View`
  background-color: ${({ theme }) => theme.colors.black};
  padding: 5px;
`;

export const PersonsImagesContent = styled.View`
  flex-direction: row;
  justify-content: center;
  align-items: flex-start;
`;

export const PersonsTitle = styled.Text`
  font-size: 16px;
  font-family: ${({ theme }) => theme.fontFamily.Axiforma_Regular};
  color: ${({ theme }) => theme.colors.white};
...
export const PersonsText = styled(PersonsTitle)`
  margin-top: 0;
`;
